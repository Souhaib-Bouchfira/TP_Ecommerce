...
<body>
    <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand" href="index.php?page=home"><i class="bi bi-box-seam-fill"></i> E-Commerce Demo</a>
    ...
    <main class="container mt-4 mb-5">
        ...
        ?>
            <div class="alert alert-dismissible alert-success">
                ...
                <h4 class="alert-heading">Bienvenue sur BOUCHFIRA E-Commerce</h4>
